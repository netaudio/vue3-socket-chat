...
CREATE TABLE `chat` (
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '聊天内容',
  `type` int(11) NOT NULL DEFAULT '0' COMMENT '内容类型：0html文本，1图片, 2视频',
  `status` int(11) NOT NULL COMMENT '是否发送成功：0否，1是',
  `timestamp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '时间戳',
  `create_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '创建时间',
